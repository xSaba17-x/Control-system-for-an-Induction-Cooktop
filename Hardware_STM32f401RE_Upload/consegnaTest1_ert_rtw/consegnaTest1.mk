###########################################################################
## Makefile generated for component 'consegnaTest1'. 
## 
## Makefile     : consegnaTest1.mk
## Generated on : Sat Jun 17 20:35:16 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/consegnaTest1.elf
...
COMPILER_COMMAND_FILE     = consegnaTest1_comp.rsp
CMD_FILE                  = consegnaTest1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/consegnaTest1.elf
...
DEFINES_STANDARD = -DMODEL=consegnaTest1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/MW_digitalIO.cpp $(START_DIR)/consegnaTest1_ert_rtw/consegnaTest1.c $(START_DIR)/consegnaTest1_ert_rtw/consegnaTest1_data.c C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/stmnucleo/STM32F401RE/src/mw_mbed_interface.cpp C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/BufferedSerial.cpp C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/stmnucleo/src/blapp_support.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/SysTickScheduler.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/m3m4m4f_multitasking.c

MAIN_SRC = $(START_DIR)/consegnaTest1_ert_rtw/ert_main.c
...
OBJS = MW_digitalIO.o consegnaTest1.o consegnaTest1_data.o mw_mbed_interface.o BufferedSerial.o blapp_support.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/consegnaTest1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/consegnaTest1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/consegnaTest1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/consegnaTest1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/consegnaTest1_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_digitalIO.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/MW_digitalIO.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


consegnaTest1.o : $(START_DIR)/consegnaTest1_ert_rtw/consegnaTest1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


consegnaTest1_data.o : $(START_DIR)/consegnaTest1_ert_rtw/consegnaTest1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/consegnaTest1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_mbed_interface.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/stmnucleo/STM32F401RE/src/mw_mbed_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
blapp_support.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/stmnucleo/src/blapp_support.c
	$(CC) $(CFLAGS) -o "$@" "$<"
